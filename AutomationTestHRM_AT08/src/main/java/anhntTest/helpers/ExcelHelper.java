...
public class ExcelHelper {
    ...
    public Object[][] getDataHashTable(String excelPath, String sheetName) {
        System.out.println("Excel Path: " + excelPath);
        Object[][] data = null;
        ...
        try {
            ...
            int rowsTotal = getLastRowNum();
            int columnsTotal = getColumns();

            System.out.println("Row: " + rowsTotal + " - Column: " + columnsTotal);
            System.out.println("StartRow: " + 1 + " - EndRow: " + rowsTotal);

            data = new Object[rowsTotal][1];
            Hashtable<String, String> table = null;
            for (int row = 1; row <= rowsTotal; row++) {
                table = new Hashtable<>();
                for (int colNum = 0; colNum < columnsTotal; colNum++) {
                    table.put(getCellData(colNum, 0), getCellData(colNum, row));
                }
                data[rowsTotal - row][0] = table;
            }
